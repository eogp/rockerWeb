...
<html>
    ...
    <body >
        ...
        <div class="container">
            <br/>
            <h3>Ups, algo no salio bien</h3>
            <br/>
            <section class="main row">
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div>
                        MercadoPago rechazo el pago, pero no te preocupes ya guardamos tu publicación.
                        Podes volver a intentarlo mas tarde desde la home.
                    </div>
                    <br/>
                    <div>
