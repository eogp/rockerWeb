                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="panel panel-default"> 
                        ...
                        <div class="panel-body">
                            <p>  Ocurrio un error al generar el alta de la publicación. <br>Por favor verifique que los datos ingresados sean correctos.</p>
                        </div> 
                    </div>
                    <a href="PUserNPub.php" class="btn btn-default form-control">Volver</a>  
                </div>
            </section>
        </div>
