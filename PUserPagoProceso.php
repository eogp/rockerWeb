        ...
        <div class="container">
            ...
            <section class="main row">
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div>
                        Estamos espercando la confirmacion de MercadoPago, pronto recibiras un email con la confirmacion de la operación y podras visualizar tu publicacion en RockerApp!   
                    </div>
                    <br/>
                    <div>
