                ...
                <div class="col-xs-12 col-sm-10 col-md-4 col-lg-4">
                    ...
                    <form  action="controlador.php" method="POST">
                        <div class="form-group">
                            <label >Ingrese su email:</label><input class="form-control" type="text" name="email">
                            <label >Ingrese su contraseña:</label><input class="form-control" type="password" name="pass">
                            <br>
                            <div class="g-recaptcha" data-sitekey="6Ld8qkkUAAAAAFy9Ykq2DUIGYRGKqHR8Rb4C_-_D"></div>
                            <br>
                            <input class="btn btn-default btn-sm btn-block" type="submit" name="login" value="Ingresar">
                            <a href="PassRecovery.php" class="btn btn-default btn-sm btn-block">Olvido su contraseña?</a>
                        </div>
                    </form>
                </div>
